...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0a3a66" },
      { property: "og:site_name", content: "Coastal Pool Service" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "Coastal Pool Service | Professional Pool Cleaning Services" },
      { name: "twitter:title", content: "Coastal Pool Service | Professional Pool Cleaning Services" },
      { property: "og:description", content: "Professional pool cleaning, maintenance, and chemical balancing. Get a free quote from Coastal Pool Service today." },
      { name: "twitter:description", content: "Professional pool cleaning, maintenance, and chemical balancing. Get a free quote from Coastal Pool Service today." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description: "Residential pool cleaning and maintenance services.",
          telephone: "+1-281-515-7039",
          email: "alanizjaden4@gmail.com",
          priceRange: "$$",
